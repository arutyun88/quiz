...
abstract class $PageInfoCopyWith<$Res> {
  ...
  @useResult
  $Res call({int page, int limit, bool hasNextPage});
}
...
class _$PageInfoImpl implements _PageInfo {
  _$PageInfoImpl(
      {required this.page, required this.limit, required this.hasNextPage});
  ...
  @override
  String toString() {
    return 'PageInfo(page: $page, limit: $limit, hasNextPage: $hasNextPage)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, page, limit, hasNextPage);
...
abstract class _PageInfo implements PageInfo {
  factory _PageInfo(
      ...
      required final bool hasNextPage}) = _$PageInfoImpl;
