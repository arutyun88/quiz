...
final userStatisticsProvider = StateNotifierProvider<UserStatisticsNotifier,
    BaseState<UserStatisticsEntity>>(
...
class UserStatisticsNotifier
    extends StateNotifier<BaseState<UserStatisticsEntity>> {
