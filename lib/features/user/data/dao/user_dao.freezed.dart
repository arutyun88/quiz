...
abstract class $UserDaoCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String email, String? name, String? birthDateIso});
}
...
class _$UserDaoImpl extends _UserDao {
  const _$UserDaoImpl(
      {required this.id, required this.email, this.name, this.birthDateIso})
      : super._();
  ...
  @override
  String toString() {
    return 'UserDao(id: $id, email: $email, name: $name, birthDateIso: $birthDateIso)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, email, name, birthDateIso);
...
abstract class _UserDao extends UserDao {
  const factory _UserDao(
      ...
      final String? name,
      final String? birthDateIso}) = _$UserDaoImpl;
