...
class _$UserLevelEntityImpl implements _UserLevelEntity {
  ...
  @override
  String toString() {
    return 'UserLevelEntity(level: $level, experience: $experience, totalPoints: $totalPoints, questionsAnswered: $questionsAnswered, correctAnswers: $correctAnswers, accuracy: $accuracy, streakDays: $streakDays)';
  }
...
abstract class _UserLevelEntity implements UserLevelEntity {
  const factory _UserLevelEntity(
      ...
      required final int streakDays}) = _$UserLevelEntityImpl;
